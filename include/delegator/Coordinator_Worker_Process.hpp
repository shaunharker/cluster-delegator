...
inline Coordinator_Worker_Process::~ Coordinator_Worker_Process( void )  { }

inline void Coordinator_Worker_Process::command_line ( int argcin, char * argvin [] ) {
  argc = argcin;
  argv = argvin;
}
...
inline void Coordinator_Worker_Process::finalize ( void ) {}
